...
function Client(transport, fastPathTransport) {
	...
	this.clientCapabilities[caps.CapsType.CAPSTYPE_CONTROL] = caps.controlCapability();
	this.clientCapabilities[caps.CapsType.CAPSTYPE_ACTIVATION] = caps.windowActivationCapability();
	this.clientCapabilities[caps.CapsType.CAPSTYPE_SHARE] = caps.shareCapability();
}
...
Client.prototype.sendClientFinalizeSynchronizePDU = function() {
	...
	this.sendDataPDU(data.synchronizeDataPDU(1002));	// TargetChannel = ServerChannel , ServerChannel = GlobalChannel - 1
